...
DATA_PATH = '/home/lhl/data/data/dataset/' # path for datasets
...
class ICRA2022(data.Dataset):
    ...
    def __init__(self, export=False, transform=None, task='train', **config):
        ...
        # get files
        base_path = Path(DATA_PATH, 'ICRA2022/' + task + '/query_images')
