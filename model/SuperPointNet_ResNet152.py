...
class SuperPointNet_ResNet152(torch.nn.Module):
    """ Pytorch definition of SuperPoint Network. """

    def __init__(self, subpixel_channel=1):
        super(SuperPointNet_ResNet152, self).__init__()
        c1, c2, c3, c4, c5, d1 = 64, 64, 128, 128, 256, 256
        det_h = 65

        # Encoder
        self.backbone = torchvision.models.resnet152(weights=True)
        ...
        self.up = nn.ConvTranspose2d(2048, 256, 4, stride=4)
    ...
    def forward(self, x):
        ...
        x3 = self.maxpool(x2)
        x4 = self.layer1(x3)
        x5 = self.layer2(x4) #(32, 512, 32, 32)
        # x6 = self.layer3(x5)
        # x7 = self.layer4(x6)
        ...
        cPa = self.relu(self.bnPa(self.convPa(x5)))
        semi = self.bnPb(self.convPb(cPa))
        # Descriptor Head.
        cDa = self.relu(self.bnDa(self.convDa(x5)))
...
def main():
    ...
    model = SuperPointNet_ResNet152l()
